...
growth_hacking = Product.create(title: "Ireland's Best Cycle Routes", 
...
growth_hacking_monthly = Product.create(title: "Ireland's Best Cycle Routes Monthly", 
 subtitle: "Ireland Best Cycle Routes to last you a Month", author: "Stephen Kearney", length: "6 months", author_image_name: 'teacher-image.jpg', 
 price: "4.99", sku: "MAP2", download_url: "https://s3-eu-west-1.amazonaws.com/ror-payments/WAW.png", details: "We'll charge you monthly for a subscription to our entire database of cycle-routes",
 description: %{<p>In this series, you will get access to all of our recommended cycle routes. A good cycle route is a rare combination: somewhere with the right views and ease of traversing, within a safe environment and close to interesting stops and esential pit-stops.</p>
